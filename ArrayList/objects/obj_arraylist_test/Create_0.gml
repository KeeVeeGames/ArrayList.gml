...
time1 = get_timer();
repeat(100) list1 = new ArrayList();
time2 = get_timer();
...
time1 = get_timer();
repeat(100) list2 = ds_list_create();
time2 = get_timer();
...
time1 = get_timer();
repeat(100) ds_list_add(list2, 12345);
time2 = get_timer();
